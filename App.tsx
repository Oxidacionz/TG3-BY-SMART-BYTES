    ...
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-900 rounded-xl p-1 text-white flex items-center shadow-lg overflow-hidden">
                <div className="bg-brand-600 px-4 py-3 rounded-lg flex flex-col items-center min-w-[120px]">
                   ...
                   <span className="text-xl font-bold">36.00 VES</span>
                </div>
                <div className="flex-1 flex items-center justify-between px-6">
                   ...
                   <div className="flex gap-8 text-sm">
                      <div className="text-right">
                         ...
                         <div className="font-bold">$ 35.50</div>
                         <div className="text-xs text-slate-500">€ 38.20</div>
                      </div>
                      <div className="text-right border-l border-slate-700 pl-8">
                         ...
                         <div className="font-bold text-yellow-400">BUY 36.10</div>
                         <div className="text-xs text-yellow-600">SELL 35.90</div>
                      </div>
                      <div className="text-right border-l border-slate-700 pl-8">
                         <div className="text-xs text-slate-400">Zelle</div>
                         <div className="font-bold text-green-400">36.00</div>
                      </div>
                   </div>
                </div>
              </div>
      ...
      >
        <div className="flex flex-col md:flex-row gap-6">
          {/* Scan Section */}
          <div className="w-full md:w-1/3 bg-slate-900 rounded-xl p-6 text-center text-white flex flex-col items-center justify-center relative overflow-hidden">
             ...
             <div className="relative z-10 w-full">
                ...
                <div className="space-y-3 w-full">
                   <button className="w-full bg-brand-600 hover:bg-brand-700 text-white py-2 rounded-lg font-bold text-sm flex items-center justify-center gap-2">
                      <Icons.Camera /> Usar Cámara
                   </button>
                   <button className="w-full bg-slate-700 hover:bg-slate-600 text-white py-2 rounded-lg font-bold text-sm flex items-center justify-center gap-2">
          ...
          <div className="flex-1 space-y-4">
             <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                   ...
                   <select className="w-full p-2 bg-slate-100 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                ...
                <div className="space-y-1">
                   ...
                   <select className="w-full p-2 bg-slate-100 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                      <option>Camello_1</option>
                      <option>Camello 2</option>
                   </select>
                </div>
             </div>
             ...
             <div className="space-y-1">
                ...
                <Input placeholder="Nombre completo del nuevo cliente" />
             </div>
             ...
             <div className="grid grid-cols-2 gap-4">
               <div className="space-y-1">
                  ...
                  <div className="flex gap-2">
                     ...
                     <select className="bg-slate-700 text-white rounded px-2 text-sm"><option>VES</option><option>USD</option></select>
                  </div>
               </div>
               <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-500 uppercase">Tasa de Cambio</label>
                  <Input type="number" placeholder="36.00" />
               </div>
             </div>
             ...
             <div className="grid grid-cols-2 gap-4">
               ...
               <div className="space-y-1">
                  ...
                  <select className="w-full p-2 bg-slate-100 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700 text-sm h-[38px]">
                      <option>Seleccionar cuenta interna...</option>
                      <option>Banesco Panama</option>
             ...
             <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                   ...
                   <Input placeholder="Ej. Banesco, Mercantil..." />
                </div>
                <div className="space-y-1">
             ...
             <div className="space-y-1">
                ...
                <textarea className="w-full p-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-md text-sm" rows={2} placeholder="Opcional..."></textarea>
             </div>

             <div className="pt-4 flex justify-end gap-3">
                <Button variant="ghost" onClick={() => setTransactionModalOpen(false)}>Cancelar</Button>
                <Button variant="primary" onClick={() => setTransactionModalOpen(false)}>Guardar Transacción</Button>
             </div>
          </div>
        </div>
      </Modal>
